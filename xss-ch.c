...
void banner(){
   ...
   char creator[] = "William Steven";         printf(CYAN "______________________________________________________________________________\n\n");
    printf(" /$$   /$$  /$$$$$$   /$$$$$$           /$$$$$$  /$$   /$$\n");
    printf("| $$  / $$ /$$__  $$ /$$__  $$         /$$__  $$| $$  | $$\n");
    printf("|  $$/ $$/| $$  \\__/| $$  \\__/        | $$  \\__/| $$  | $$\n");
    printf(" \\  $$$$/ |  $$$$$$ |  $$$$$$  /$$$$$$| $$      | $$$$$$$$\n");
    ...
    printf(WHITE "\nPresented by team %s\nCreated by %s\n",team_name,creator);
    printf(CYAN"______________________________________________________________________________\n\n" RESET);
}
int tgb(){
